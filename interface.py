...
def affichage(niveau,parcour):
	...
	if edition == 0 :
		fenetre.blit(bouton_editer1,(400,1014))
	else:
		fenetre.blit(bouton_editer2,(400,1014))
	if modification == 0 :
		fenetre.blit(bouton_modif1,(800,956))
	else:
		fenetre.blit(bouton_modif2,(800,956))
	...
	for event in pygame.event.get():
		...
		if etat_fond == 1 and wait == 0 :
			...
			if modification == 0:
				...
				if event.type == MOUSEBUTTONDOWN and event.button == 1 and event.pos[0] >= 0 and event.pos[0] < 1586  and event.pos[1] >= 0 and event.pos[1] < 753:
					compteur = compteur + 1
					if compteur == 1 :
						x[0] = event.pos[0]
						y[0] = event.pos[1]
			...
			if  event.type == MOUSEBUTTONDOWN and event.button == 1 and event.pos[0] > 800 and event.pos[0] < 1118 and event.pos[1] > 956 and event.pos[1] < 1080:
				modification = 1
				compteur = 0
				bloquage1 = 0
				bloquage2 = 0
			...
			if  event.type == MOUSEBUTTONDOWN and event.button == 1 and event.pos[0] > 400 and event.pos[0] < 602 and event.pos[1] > 1014 and event.pos[1] < 1070:
				edition = 1
				nom = ""
				wait = 1
